...
public class MessageFinderTest {
    ...
    public void testGetMessage() throws BundleNotFound, MessageNotFound {
        ...
        Assert.assertEquals(finder.getMessage(new MessageQuery("en", "US", "edit", "Bug", "form.submit.value"), "FormBundle"), "Edit");
        Assert.assertEquals(finder.getMessage(new MessageQuery("cs", "CZ", "edit", "Bug", "form.submit.value"), "FormBundle"), "Upravit");
    }
    ...
    public void testGetMessageFromUndefinedBundle() throws BundleNotFound, MessageNotFound {
        MessageFinder finder = new MessageFinder();
        finder.getMessage(new MessageQuery("en", "US", "edit", "Bug", "form.submit.value"), "UNDEFINED");
    }
    ...
    public void testGetMessageWithUndefinedName() throws BundleNotFound, MessageNotFound {
        MessageFinder finder = new MessageFinder();
        finder.getMessage(new MessageQuery("en", "US", "edit", "Bug", "UNDEFINED"), "FormBundle");
    }

    @Test
    public void testGetMessages() throws BundleNotFound, ClassNotFound, ContextNotFound {
        MessageFinder finder = new MessageFinder();
        Map<String, String> messages = finder.getMessages(new MessageQuery("en", "US", "edit", "Bug", null), "FormBundle");
    ...
    public void testGetMessagesFromUndefinedBundle() throws BundleNotFound, ClassNotFound, ContextNotFound {
        MessageFinder finder = new MessageFinder();
        Map<String, String> messages = finder.getMessages(new MessageQuery("en", "US", "edit", "Bug", null), "UNDEFINED");
    }
    ...
    public void testGetMessagesOfUndefinedContext() throws ContextNotFound, BundleNotFound, ClassNotFound {
        MessageFinder finder = new MessageFinder();
        Map<String, String> messages = finder.getMessages(new MessageQuery("en", "US", "UNDEFINED", "Bug", null), "FormBundle");
    }
